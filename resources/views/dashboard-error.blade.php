 ...
 <html>
    ...
    <div class="relative">
		...
		<div class="flex flex-wrap w-full lg:w-auto">
			<div class="rounded-lg py-6 pl-8 pr-32 w-full bg-blue-900 opacity-90 text-white content-center">			
				<h3 class="font-bold text-3xl leading-none pb-1 content-center ">Please enter a valid city to display weather for</h3>
			</div>
		</div>
	</body>
</html>